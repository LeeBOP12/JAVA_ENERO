...
public class Ejercicio1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TITULO.setText("CUADRADO DE LOS NUMEROS \"1 - N\"");
    ...
    private void OPERARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OPERARActionPerformed
        /*
        Imprimir los cuadrados de los números del 1 al N
        Descripción: Pide un número N al usuario e imprime el cuadrado de cada número entre 1 y N. (5P)
         */
        ...
        if (num>0) {
            for (int i = 1; i <= num; i++) {
                cuadrado = i * i;
                MOSTRAR.append(String.valueOf(cuadrado + "\n"));
            }
        } else {
            MOSTRAR.setText("ESCRIBA UN NUMERO MAYOR O IGUAL A 1 ");
        }
